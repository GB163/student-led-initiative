// colleges.ts - Place this file in your constants or data folder
// Example: /shared/constants/colleges.ts or /data/colleges.ts
...
// Optional: Helper function to get sorted colleges
export const getSortedColleges = () => {
  return [...colleges].sort((a, b) => a.localeCompare(b));
};

// Optional: Helper function to search colleges
